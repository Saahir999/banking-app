        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: Align(
              ...
              child: DotsIndicator(dotsCount: 3, position: currentIndexPage.toDouble(), decorator: const DotsDecorator(color: Banking_view_color, activeColor: Banking_Primary)),
            ),
          ),
          Positioned(
            width: context.width(),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  BankingButton(
                    ...
                    onPressed: () {
                      finish(context);
                      const BankingSignIn().launch(context,isNewTask: true);
                    },
                  ),
                ],
              ),
